...
<div class="row">
    ...
    <div>
        <input type="checkbox" id="estáFormado" name="contratado" value="1" data-expected-info="contratado" class="form-control @error('contratado') is-invalid @enderror" required>
        @error('contratado')
        <span class="invalid-feedback" role="alert">
            <i class="fi-circle-cross"></i><strong> {{ $message }}</strong>
        </span>
