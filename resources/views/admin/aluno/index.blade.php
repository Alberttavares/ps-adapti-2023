				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12">
							...
							<input type="text" id="detalhes-nome" nome="detalhes-nome" class="form-control" readonly>
						</div>

						<div class="form-group col-md-12 col-sm-12">
							<h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Descrição do Aluno</h5>
							<input type="text" id="detalhes-descricao" nome="detalhes-descricao" class="form-control" readonly>
						</div>

						<div class="form-group col-md-12 col-sm-12">
							<h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Está formado?</h5>
							<input type="text" id="detalhes-formado" nome="detalhes-formado" class="form-control" readonly>
							<span id="formado-status"></span>
						</div>

						<div class="form-group col-md-12 col-sm-12">
							<h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Está contratado?</h5>
							<input type="text" id="detalhes-contratado" nome="detalhes-contratado" class="form-control" readonly>
							<span id="contratado-status"></span>
						</div>


						<div class="form-group col-md-12 col-sm-12">
							<h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Curso do Aluno</h5>
							<input type="text" id="detalhes-cursos" nome="detalhes-cursos" class="form-control" readonly>
						</div>
...
<script>
	...
	$('#modal-detalhes').on('show.bs.modal', function(event) {
		...
		$.getJSON(url, (resposta) => {
			...
			$("#detalhes-cursos").val(resposta.cursos.curso);
			$("#detalhes-imagem").attr('src', '' + resposta.imagem);
			$("#detalhes-contratado").val(resposta.contratado);
			$("#detalhes-formado").val(resposta.formado);
			const contratadoStatus = resposta.contratado ? 'Sim' : 'Não';
			$("#contratado-status").text(contratadoStatus);

			const formadoStatus = resposta.formado ? 'Sim' : 'Não';
			$("#formado-status").text(formadoStatus);
